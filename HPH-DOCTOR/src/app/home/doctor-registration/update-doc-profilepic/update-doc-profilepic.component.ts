...
@Component({
  selector: 'app-update-doc-profilepic',
  templateUrl: './update-doc-profilepic.component.html',
  styleUrls: ['./update-doc-profilepic.component.css']
})
export class UpdateDocProfilepicComponent implements OnInit {
