...
@Component({
  selector: 'app-update-doc-timeslots',
  templateUrl: './update-doc-timeslots.component.html',
  styleUrls: ['./update-doc-timeslots.component.css']
})
export class UpdateDocTimeslotsComponent implements OnInit {
  @Output() nextClickTiming = new EventEmitter();
  Practise = 'no';
