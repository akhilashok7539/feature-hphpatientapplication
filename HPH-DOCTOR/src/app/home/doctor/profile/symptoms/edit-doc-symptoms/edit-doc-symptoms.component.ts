...
@Component({
  selector: 'app-edit-doc-symptoms',
  templateUrl: './edit-doc-symptoms.component.html',
  styleUrls: ['./edit-doc-symptoms.component.css']
})
export class EditDocSymptomsComponent implements OnInit {
    ...
    for(let j=0;j<this.doctorsymptoms.length;j++){
     ...
     this.doctorservice.addSymptoms(req).subscribe(
       ...
       error =>{
        ...
        this.completeprofile = 'Update Symptoms';
