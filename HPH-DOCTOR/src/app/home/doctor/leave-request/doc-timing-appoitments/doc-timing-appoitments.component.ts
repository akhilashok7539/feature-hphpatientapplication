...
@Component({
  selector: 'app-doc-timing-appoitments',
  templateUrl: './doc-timing-appoitments.component.html',
  styleUrls: ['./doc-timing-appoitments.component.css']
})
export class DocTimingAppoitmentsComponent implements OnInit {
