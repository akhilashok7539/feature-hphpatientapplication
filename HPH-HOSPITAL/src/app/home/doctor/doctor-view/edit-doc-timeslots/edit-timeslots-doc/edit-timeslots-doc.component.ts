...
@Component({
  selector: 'app-edit-timeslots-doc',
  templateUrl: './edit-timeslots-doc.component.html',
  styleUrls: ['./edit-timeslots-doc.component.css']
})
export class EditTimeslotsDocComponent implements OnInit {
  Practise = 'no';
