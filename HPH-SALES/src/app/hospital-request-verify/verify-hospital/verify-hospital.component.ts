...
import { HospitalService } from 'src/app/home/hospital.service';
import { ActivatedRoute } from '@angular/router';

@Component({
  selector: 'app-verify-hospital',
  templateUrl: './verify-hospital.component.html',
  styleUrls: ['./verify-hospital.component.css']
})
export class VerifyHospitalComponent implements OnInit {
  hospitlaDetails:any;
  name:any;
  mob:any;
  email:any;
